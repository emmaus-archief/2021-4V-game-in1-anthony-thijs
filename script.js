...
var schadePlatformX2 = [70, 315, 618, 822];
...
function draw() {
  switch (spelStatus) {
    ...
    text("Druk op de 1 2 3 toesten om een level/game te starten. Om te wisselen van level ga af druk op 1 ga af en druk op het level wat u wilt spelen", 40, 150, 1240, 700)
